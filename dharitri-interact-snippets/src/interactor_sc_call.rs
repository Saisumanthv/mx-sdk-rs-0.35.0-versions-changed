use crate::{address_h256_to_erdrs, denali_to_erdrs_address, Interactor, InteractorResult};
use dharitri_sdk_erdrs::data::transaction::Transaction;
...
impl Interactor {
    fn tx_call_to_blockchain_tx(&self, tx_call: &TxCall) -> Transaction {
        ...
        Transaction {
            ...
            sender: denali_to_erdrs_address(&tx_call.from),
