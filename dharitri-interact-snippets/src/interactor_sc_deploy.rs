use crate::{denali_to_erdrs_address, Interactor, InteractorResult};
use dharitri_sdk_erdrs::data::{address::Address as ErdrsAddress, transaction::Transaction};
...
impl Interactor {
    fn sc_deploy_to_tx(&self, sc_deploy_step: &ScDeployStep) -> Transaction {
        Transaction {
            ...
            sender: denali_to_erdrs_address(&sc_deploy_step.tx.from),
